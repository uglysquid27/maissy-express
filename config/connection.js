...
const env = ['development','duasatuempat','empattujuh','kluber', 'login', 'node_red'];
...
const node_red = require('./config.json')[env[5]];
...
const connectNode = new Sequelize(node_red.database, node_red.username, node_red.password, node_red);
